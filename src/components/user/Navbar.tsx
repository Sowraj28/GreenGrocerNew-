      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-1">
            <Link
              href="/shop"
              className="flex items-center gap-2 px-4 py-2 rounded-xl text-gray-600 hover:text-brand-primary hover:bg-brand-50 font-medium transition-all"
            >
              <FiHome size={16} /> Shop
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/cart"
              className="relative p-2.5 rounded-xl hover:bg-brand-50 transition-colors group"
            >
              <FiShoppingCart
                size={22}
                className="text-gray-600 group-hover:text-brand-primary"
              />
              {totalItems > 0 && (
